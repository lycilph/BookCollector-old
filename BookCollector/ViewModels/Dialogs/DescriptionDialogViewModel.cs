...
{
    public class DescriptionDialogViewModel : ReactiveObject
    {
        ...
        public DescriptionDialogViewModel(DescriptionViewModel description, Action<MessageDialogResult> close_handler)
        {
